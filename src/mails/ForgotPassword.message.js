...
export const ForgotPasswordMessage = async (userEmail, firstName, newPassword) => {
    ...
    const mailOptions = {
        ...
        subject: 'Password Recovery on Alistar.ltd',
        html: `
            <!DOCTYPE html>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                                                <div
                                                                    ...
                                                                    "
                                                                >
                                                                    <span style="display: block; margin-bottom: 10px; color: #555">Hello, ${firstName}!</span>
                                                                    <span style="display: block; color: #555; margin-bottom: 10px"
                                                                        >You have received this email because you attempted to recover access to your profile on
                                                                        Alistar.ltd.</span
                                                                    >
                                                                    <span style="display: block; color: #555"
                                                                        >Here is your new password for logging into your account:</span
                                                                    >
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                                                <div
                                                                    ...
                                                                    "
                                                                >
                                                                    <span style="display: block; text-align: center"><b>${newPassword}</b></span>
                                                                </div>
                                                            </td>
                                                        </tr>

...
export const NewUserMessage = async (userEmail, firstName, newPassword) => {
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                                                <div
                                                                    ...
                                                                    "
                                                                >
                                                                    <span style="display: block; margin-bottom: 10px; color: #555">Welcome, ${firstName}!</span>
                                                                    <span style="display: block; color: #555; margin-bottom: 10px"
                                                                        >Thank you for joining alistar.ltd. You now have access to our best offers and services.</span
                                                                    >
                                                                    <span style="display: block; color: #555">Your account has been created:</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                                                <div
                                                                    ...
                                                                    "
                                                                >
                                                                    <span style="display: block; margin-bottom: 10px"><b>Email:</b> ${userEmail}</span>
                                                                    <span style="display: block"><b>Password:</b> ${newPassword}</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        >
                                                                            <p
                                                                                ...
                                                                                "
                                                                            >
                                                                                <a href="https://alistar.ltd/login" target="_blank" style="color: #ffffff">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                                                <div
                                                                    ...
                                                                    "
                                                                >
                                                                    If you encounter any issues accessing your profile, please contact support at support@alistar.ltd.
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
